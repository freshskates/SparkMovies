const requests = {
  ...
  fetchTopRated: `/movie/top_rated?api_key=${process.env.REACT_APP_MOVIE_API_KEY}&language=en-US`,
  ...
  fetchDocumentaries: `/discover/movie?api_key=${process.env.REACT_APP_MOVIE_API_KEY}&with_genres=99`,
};
